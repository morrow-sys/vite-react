...
//       }}
//     >
//       <Typography variant="h4" fontWeight="bold" mb={7} data-aos="fade-up">
//         Издательство научных журналов
//       </Typography>
...
// components/PublishingSlider.jsx
...
const PublishingSlider = () => {
  ...
  return (
    <Box
      id="publishing"
      sx={{ py: 5, backgroundColor: '#f0f0f0', textAlign: 'center' }}
    >
      <Typography variant="h4" fontWeight="bold" mb={7} data-aos="fade-up">
        Издательство научных журналов
      </Typography>
